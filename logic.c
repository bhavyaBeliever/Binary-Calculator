...
void insertAtBeginning(List *l, int val){
    Node * newNode = (Node *) malloc(sizeof(Node));
...
void addNodeAtPosition(List *l, int val, int position){
    Node *newNode, *p;
    int i;
